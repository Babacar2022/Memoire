        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ url('view_catagory') }}">
              <i class="bi bi-circle"></i><span>Catagory A</span>
            </a>
          </li>
          <li>
            <a href="{{ url('view_catagory2') }}">
              <i class="bi bi-circle"></i><span>Catagory B</span>
            </a>
          </li>
          <li>
            <a href="{{url('view_catagory3')}}">
              <i class="bi bi-circle"></i><span>Catagory C</span>
            </a>
          </li>
          <li>
